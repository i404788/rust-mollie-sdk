...
pub async fn get_next_settlement(configuration: &configuration::Configuration, idempotency_key: Option<&str>) -> Result<models::EntitySettlement, Error<GetNextSettlementError>> {
...
pub async fn get_open_settlement(configuration: &configuration::Configuration, idempotency_key: Option<&str>) -> Result<models::EntitySettlement, Error<GetOpenSettlementError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_header_idempotency_key = idempotency_key;
...
pub async fn list_settlement_chargebacks(configuration: &configuration::Configuration, settlement_id: &str, from: Option<&str>, limit: Option<i32>, embed: Option<&str>, testmode: Option<bool>, idempotency_key: Option<&str>) -> Result<models::ListSettlementChargebacks200Response, Error<ListSettlementChargebacksError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_settlement_id = settlement_id;
    let p_query_from = from;
    let p_query_limit = limit;
