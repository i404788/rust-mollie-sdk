...
pub struct SessionLineItemResponse {
...
impl SessionLineItemResponse {
    pub fn new(description: String, quantity: i32, unit_price: models::Amount, total_amount: models::Amount) -> SessionLineItemResponse {
