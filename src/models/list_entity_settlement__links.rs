...
pub struct ListEntitySettlementLinks {
    #[serde(rename = "self")]
    ...
    pub invoice: Option<models::UrlNullable>,
}

impl ListEntitySettlementLinks {
    /// An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
    pub fn new(param_self: models::Url) -> ListEntitySettlementLinks {
