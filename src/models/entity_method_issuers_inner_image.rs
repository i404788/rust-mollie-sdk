...
/// EntityMethodIssuersInnerImage : URLs of images representing the issuer. required:   - size1x   - size2x   - svg
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EntityMethodIssuersInnerImage {
...
impl EntityMethodIssuersInnerImage {
    /// URLs of images representing the issuer. required:   - size1x   - size2x   - svg
    pub fn new() -> EntityMethodIssuersInnerImage {
