...
pub struct ListSettlementCaptureResponse {
...
impl ListSettlementCaptureResponse {
    pub fn new(resource: String, id: String, mode: models::SettlementMode, amount: models::AmountNullable, status: models::SettlementCaptureStatus, payment_id: String, created_at: String, _links: models::ListEntityCaptureLinks) -> ListSettlementCaptureResponse {
