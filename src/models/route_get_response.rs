...
impl RouteGetResponse {
    pub fn new(resource: String, id: String, payment_id: String, amount: models::Amount, description: String, destination: models::EntityRouteDestination, created_at: String, _links: models::EntityRouteLinks) -> RouteGetResponse {
        RouteGetResponse {
            resource,
            id,
            payment_id,
