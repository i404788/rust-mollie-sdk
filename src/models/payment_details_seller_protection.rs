...
/// PaymentDetailsSellerProtection : Indicates to what extent the payment is eligible for PayPal's Seller Protection. Only available for PayPal payments, and if the information is made available by PayPal.
...
pub enum PaymentDetailsSellerProtection {
...
impl std::fmt::Display for PaymentDetailsSellerProtection {
...
impl Default for PaymentDetailsSellerProtection {
    fn default() -> PaymentDetailsSellerProtection {
        Self::Eligible
    }
}
