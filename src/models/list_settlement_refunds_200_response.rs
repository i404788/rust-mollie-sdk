...
pub struct ListSettlementRefunds200Response {
    ...
    pub _embedded: Box<models::ListSettlementRefunds200ResponseEmbedded>,
    #[serde(rename = "_links")]
    pub _links: Box<models::ListLinks>,
}

impl ListSettlementRefunds200Response {
    pub fn new(count: i32, _embedded: models::ListSettlementRefunds200ResponseEmbedded, _links: models::ListLinks) -> ListSettlementRefunds200Response {
