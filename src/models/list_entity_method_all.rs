...
pub struct ListEntityMethodAll {
...
impl ListEntityMethodAll {
    pub fn new(resource: String, id: Option<models::MethodId>, description: String, minimum_amount: models::Amount, maximum_amount: models::AmountNullable, image: models::EntityMethodImage, status: Option<models::MethodStatus>, _links: models::EntitySessionLinks) -> ListEntityMethodAll {
        ListEntityMethodAll {
            resource,
            id,
            description,
