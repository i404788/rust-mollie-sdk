...
pub struct ListBalanceTransactions200Response {
    ...
    pub _embedded: Option<Box<models::ListBalanceTransactions200ResponseEmbedded>>,
    #[serde(rename = "_links", skip_serializing_if = "Option::is_none")]
    pub _links: Option<Box<models::ListLinks>>,
}

impl ListBalanceTransactions200Response {
    pub fn new() -> ListBalanceTransactions200Response {
