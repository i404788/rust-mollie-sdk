...
pub struct ListBalanceTransactions200Response {
    ...
    pub _embedded: models::ListBalanceTransactions200ResponseEmbedded,
    #[serde(rename = "_links")]
    pub _links: models::ListLinks,
}

impl ListBalanceTransactions200Response {
    pub fn new(count: i32, _embedded: models::ListBalanceTransactions200ResponseEmbedded, _links: models::ListLinks) -> ListBalanceTransactions200Response {
