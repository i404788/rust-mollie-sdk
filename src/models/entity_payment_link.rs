...
pub struct EntityPaymentLink {
    ...
    pub lines: Option<Option<Vec<models::PaymentLineItemResponse>>>,
    ...
    pub allowed_methods: Option<Option<Vec<models::PaymentLinkMethodResponse>>>,
...
impl EntityPaymentLink {
    pub fn new() -> EntityPaymentLink {
        EntityPaymentLink {
            resource: None,
            id: None,
            mode: None,
