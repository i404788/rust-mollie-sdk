...
pub struct SalesInvoiceRecipientResponse {
    #[serde(rename = "type")]
    pub r#type: models::SalesInvoiceRecipientTypeResponse,
    ...
    pub country: String,
    #[serde(rename = "locale")]
    pub locale: models::SalesInvoiceRecipientLocaleResponse,
}

impl SalesInvoiceRecipientResponse {
    pub fn new(r#type: models::SalesInvoiceRecipientTypeResponse, email: String, street_and_number: String, postal_code: String, city: String, country: String, locale: models::SalesInvoiceRecipientLocaleResponse) -> SalesInvoiceRecipientResponse {
