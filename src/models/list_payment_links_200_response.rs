...
pub struct ListPaymentLinks200Response {
    ...
    pub _embedded: Box<models::ListPaymentLinks200ResponseEmbedded>,
    #[serde(rename = "_links")]
    pub _links: Box<models::ListLinks>,
}

impl ListPaymentLinks200Response {
    pub fn new(count: i32, _embedded: models::ListPaymentLinks200ResponseEmbedded, _links: models::ListLinks) -> ListPaymentLinks200Response {
