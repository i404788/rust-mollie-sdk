...
impl EntityRefundResponse {
    pub fn new(resource: String, id: String, mode: models::Mode, description: String, amount: models::Amount, metadata: Option<models::Metadata>, status: models::RefundStatusResponse, created_at: String, _links: models::EntityRefundLinks) -> EntityRefundResponse {
