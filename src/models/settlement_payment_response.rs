...
pub struct SettlementPaymentResponse {
...
impl SettlementPaymentResponse {
    pub fn new(resource: String, id: String, mode: models::SettlementMode, description: String, amount: models::Amount, sequence_type: models::SequenceTypeResponse, profile_id: String, status: models::SettlementPaymentStatus, created_at: String, _links: models::EntityPaymentLinks) -> SettlementPaymentResponse {
