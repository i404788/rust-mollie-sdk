...
impl EntityWebhook {
    pub fn new(resource: String, id: String, url: String, profile_id: Option<String>, created_at: String, name: String, event_types: Vec<models::WebhookEventTypesResponse>, status: models::WebhookStatus, mode: models::Mode, _links: models::EntityWebhookLinks) -> EntityWebhook {
        EntityWebhook {
            resource,
            id,
            url,
