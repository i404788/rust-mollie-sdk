...
impl EntityMethodGet {
    pub fn new(resource: String, id: Option<models::MethodResponse>, description: String, minimum_amount: models::Amount, maximum_amount: models::AmountNullable, image: models::EntityMethodImage, status: Option<models::MethodStatus>, _links: models::EntityMethodLinks) -> EntityMethodGet {
        EntityMethodGet {
            resource,
            id,
            description,
