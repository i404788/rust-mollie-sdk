...
pub enum MandateDetailsCardLabelResponse {
...
impl std::fmt::Display for MandateDetailsCardLabelResponse {
...
impl Default for MandateDetailsCardLabelResponse {
    fn default() -> MandateDetailsCardLabelResponse {
