...
pub struct ListEntityRefund {
    ...
    #[serde(rename = "status")]
    pub status: models::RefundStatusResponse,
    ...
    pub routing_reversals: Option<Option<Vec<models::ListEntityRefundRoutingReversalsInner>>>,
...
impl ListEntityRefund {
    pub fn new(resource: String, id: String, mode: models::Mode, description: String, amount: models::Amount, metadata: Option<models::Metadata>, status: models::RefundStatusResponse, created_at: String, _links: models::ListEntityRefundLinks) -> ListEntityRefund {
        ListEntityRefund {
            resource,
            id,
            mode,
