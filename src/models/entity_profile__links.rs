...
/// EntityProfileLinks : An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
...
pub struct EntityProfileLinks {
    ...
    pub methods: Option<Box<models::Url>>,
