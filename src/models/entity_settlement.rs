...
pub struct EntitySettlement {
    ...
    #[serde(rename = "_links")]
    pub _links: Box<models::EntitySettlementLinks>,
}

impl EntitySettlement {
    pub fn new(resource: String, id: String, status: models::SettlementStatus, amount: models::Amount, balance_id: String, _links: models::EntitySettlementLinks) -> EntitySettlement {
        EntitySettlement {
            resource,
            id,
            created_at: None,
