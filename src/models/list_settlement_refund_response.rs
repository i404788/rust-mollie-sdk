...
pub struct ListSettlementRefundResponse {
    ...
    /// The amount deducted from your account balance for this refund, converted to the currency your account is settled in. Always a **negative** amount.  For refunds not directly processed by Mollie (e.g. PayPal), the settlement amount is zero.
    ...
    #[serde(rename = "status")]
    pub status: models::SettlementRefundStatus,
    /// The entity's date and time of creation, in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format.
    #[serde(rename = "createdAt")]
    pub created_at: String,
    #[serde(rename = "externalReference", skip_serializing_if = "Option::is_none")]
    pub external_reference: Option<models::ListEntityRefundExternalReference>,
    ...
    pub routing_reversals: Option<Vec<models::ListEntityRefundRoutingReversalsInner>>,
    ...
    #[serde(rename = "_links")]
    pub _links: models::ListEntityRefundLinks,
}

impl ListSettlementRefundResponse {
    pub fn new(resource: String, id: String, mode: models::SettlementMode, description: String, amount: models::Amount, metadata: Option<models::Metadata>, status: models::SettlementRefundStatus, created_at: String, _links: models::ListEntityRefundLinks) -> ListSettlementRefundResponse {
