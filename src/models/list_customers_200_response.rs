...
pub struct ListCustomers200Response {
    ...
    pub _embedded: Box<models::ListCustomers200ResponseEmbedded>,
    #[serde(rename = "_links")]
    pub _links: Box<models::ListLinks>,
}

impl ListCustomers200Response {
    pub fn new(count: i32, _embedded: models::ListCustomers200ResponseEmbedded, _links: models::ListLinks) -> ListCustomers200Response {
