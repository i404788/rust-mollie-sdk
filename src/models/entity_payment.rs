...
pub struct EntityPayment {
    ...
    pub amount_charged_back: Option<Box<models::Amount>>,
    ...
    pub settlement_amount: Option<Box<models::Amount>>,
    ...
    pub lines: Option<Option<Vec<models::EntityPaymentLinesInner>>>,
    #[serde(rename = "billingAddress", skip_serializing_if = "Option::is_none")]
    pub billing_address: Option<Box<models::EntityPaymentBillingAddress>>,
    ...
    pub capture_mode: Option<Option<models::CaptureMode>>,
    ...
    #[serde(rename = "captureDelay", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub capture_delay: Option<Option<String>>,
    ...
    #[serde(rename = "captureBefore", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub capture_before: Option<Option<String>>,
    #[serde(rename = "applicationFee", skip_serializing_if = "Option::is_none")]
    pub application_fee: Option<Box<models::EntityPaymentApplicationFee>>,
    ...
    pub routing: Option<Option<Vec<models::EntityPaymentRoute>>>,
    ...
    pub sequence_type: Option<models::SequenceType>,
    ...
    pub status_reason: Option<Box<models::StatusReason>>,
    ...
    pub details: Option<Box<models::EntityPaymentDetails>>,
    ...
    #[serde(rename = "authorizedAt", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "expiredAt", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "failedAt", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    pub _links: Option<Box<models::EntityPaymentLinks>>,
}

impl EntityPayment {
    pub fn new() -> EntityPayment {
        EntityPayment {
            resource: None,
            id: None,
            mode: None,
