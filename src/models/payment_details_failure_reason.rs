...
/// PaymentDetailsFailureReason : A failure code to help understand why the payment failed.
/// A failure code to help understand why the payment failed.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum PaymentDetailsFailureReason {
...
impl std::fmt::Display for PaymentDetailsFailureReason {
...
impl Default for PaymentDetailsFailureReason {
    fn default() -> PaymentDetailsFailureReason {
