...
pub struct ListWebhooks200Response {
    ...
    pub _embedded: Box<models::ListWebhooks200ResponseEmbedded>,
    #[serde(rename = "_links")]
    pub _links: Box<models::ListLinks>,
}

impl ListWebhooks200Response {
    pub fn new(count: i32, _embedded: models::ListWebhooks200ResponseEmbedded, _links: models::ListLinks) -> ListWebhooks200Response {
