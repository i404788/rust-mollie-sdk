...
pub struct ListSettlementPaymentResponse {
    ...
    /// The amount settled to your account for this payment, converted to the currency your account is settled in.  Amounts not settled by Mollie are not reflected here (e.g. PayPal or gift cards). If no amount is settled by Mollie, this field is omitted from the response.
    ...
    #[serde(rename = "status")]
    pub status: models::SettlementPaymentStatus,
    ...
    #[serde(rename = "_links")]
    pub _links: models::ListEntityPaymentLinks,
}

impl ListSettlementPaymentResponse {
    pub fn new(resource: String, id: String, mode: models::SettlementMode, description: String, amount: models::Amount, sequence_type: models::SequenceTypeResponse, profile_id: String, status: models::SettlementPaymentStatus, created_at: String, _links: models::ListEntityPaymentLinks) -> ListSettlementPaymentResponse {
