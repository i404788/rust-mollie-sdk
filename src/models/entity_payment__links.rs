...
pub struct EntityPaymentLinks {
    ...
    pub change_payment_state: Option<Box<models::Url>>,
    /// Direct link to the payment in the Mollie Dashboard.
    #[serde(rename = "dashboard")]
    pub dashboard: Box<models::Url>,
    ...
    pub order: Option<Box<models::Url>>,
    ...
    pub terminal: Option<Box<models::Url>>,
    ...
    pub status: Option<Box<models::Url>>,
    ...
    pub pay_online: Option<Box<models::Url>>,
}
