...
pub struct ListSalesInvoiceResponse {
    ...
    pub payment_details: Option<Vec<models::SalesInvoicePaymentDetailsResponse>>,
    ...
    pub lines: Option<Vec<models::SalesInvoiceLineItemResponse>>,
...
impl ListSalesInvoiceResponse {
    pub fn new(resource: String, id: String, mode: models::Mode) -> ListSalesInvoiceResponse {
