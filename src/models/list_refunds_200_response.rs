...
pub struct ListRefunds200Response {
    ...
    pub _embedded: models::ListRefunds200ResponseEmbedded,
    #[serde(rename = "_links")]
    pub _links: models::ListLinks,
}

impl ListRefunds200Response {
    pub fn new(count: i32, _embedded: models::ListRefunds200ResponseEmbedded, _links: models::ListLinks) -> ListRefunds200Response {
