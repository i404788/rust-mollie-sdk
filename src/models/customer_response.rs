...
impl CustomerResponse {
    pub fn new(resource: String, id: String, mode: models::Mode, name: String, email: String, locale: Option<models::LocaleResponse>, metadata: Option<models::Metadata>, created_at: String, _links: models::EntityCustomerLinks) -> CustomerResponse {
        CustomerResponse {
            resource,
            id,
            mode,
