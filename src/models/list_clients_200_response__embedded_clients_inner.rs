...
pub struct ListClients200ResponseEmbeddedClientsInner {
    ...
    #[serde(rename = "_links")]
    pub _links: models::ListEntityClientLinks,
    #[serde(rename = "_embedded", skip_serializing_if = "Option::is_none")]
    pub _embedded: Option<models::ListClients200ResponseEmbeddedClientsInnerAllOfEmbedded>,
}

impl ListClients200ResponseEmbeddedClientsInner {
    pub fn new(resource: String, id: String, _links: models::ListEntityClientLinks) -> ListClients200ResponseEmbeddedClientsInner {
