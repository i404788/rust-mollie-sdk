...
pub struct ListEntitySubscription {
    ...
    pub status: Option<models::SubscriptionStatusResponse>,
    ...
    #[serde(rename = "times", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub times: Option<Option<i32>>,
    /// Number of payments left for the subscription.
    #[serde(rename = "timesRemaining", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub times_remaining: Option<Option<i32>>,
    ...
    #[serde(rename = "nextPaymentDate", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    pub _links: Option<models::ListEntitySubscriptionLinks>,
}

impl ListEntitySubscription {
    pub fn new() -> ListEntitySubscription {
