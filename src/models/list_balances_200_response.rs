...
pub struct ListBalances200Response {
    ...
    pub _embedded: models::ListBalances200ResponseEmbedded,
    #[serde(rename = "_links")]
    pub _links: models::ListLinks,
}

impl ListBalances200Response {
    pub fn new(count: i32, _embedded: models::ListBalances200ResponseEmbedded, _links: models::ListLinks) -> ListBalances200Response {
