...
pub struct SubscriptionRequest {
    ...
    pub method: Option<Option<models::SubscriptionMethod>>,
    #[serde(rename = "applicationFee", skip_serializing_if = "Option::is_none")]
    pub application_fee: Option<Box<models::EntitySubscriptionApplicationFee>>,
    ...
    pub _links: Option<Box<models::EntitySubscriptionLinks>>,
}
