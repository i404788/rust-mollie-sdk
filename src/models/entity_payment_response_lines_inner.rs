...
pub struct EntityPaymentResponseLinesInner {
    #[serde(rename = "type", skip_serializing_if = "Option::is_none")]
    pub r#type: Option<models::PaymentLineTypeResponse>,
    ...
    pub unit_price: Box<models::Amount>,
    ...
    pub discount_amount: Option<Box<models::Amount>>,
    ...
    pub total_amount: Box<models::Amount>,
    ...
    pub vat_amount: Option<Box<models::Amount>>,
    ...
    pub categories: Option<Vec<models::LineCategoriesResponse>>,
    ...
    pub recurring: Option<Box<models::RecurringLineItem>>,
}

impl EntityPaymentResponseLinesInner {
    pub fn new(description: String, quantity: i32, unit_price: models::Amount, total_amount: models::Amount) -> EntityPaymentResponseLinesInner {
