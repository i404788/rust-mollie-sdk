...
impl ListPaymentResponse {
    pub fn new(resource: String, id: String, mode: models::Mode, description: String, amount: models::Amount, sequence_type: models::SequenceTypeResponse, profile_id: String, status: models::PaymentStatus, created_at: String, _links: models::ListEntityPaymentLinks) -> ListPaymentResponse {
        ListPaymentResponse {
            resource,
            id,
            mode,
