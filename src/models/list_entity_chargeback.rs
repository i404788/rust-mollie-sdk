...
pub struct ListEntityChargeback {
...
impl ListEntityChargeback {
    pub fn new(resource: String, id: String, amount: models::Amount, payment_id: String, created_at: String, _links: models::ListEntityChargebackLinks) -> ListEntityChargeback {
