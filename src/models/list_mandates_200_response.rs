...
pub struct ListMandates200Response {
    ...
    pub _embedded: Box<models::ListMandates200ResponseEmbedded>,
    #[serde(rename = "_links")]
    pub _links: Box<models::ListLinks>,
}

impl ListMandates200Response {
    pub fn new(count: i32, _embedded: models::ListMandates200ResponseEmbedded, _links: models::ListLinks) -> ListMandates200Response {
