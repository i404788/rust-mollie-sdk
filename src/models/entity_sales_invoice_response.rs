...
pub struct EntitySalesInvoiceResponse {
    ...
    pub payment_details: Option<Box<models::SalesInvoicePaymentDetailsResponse>>,
    ...
    pub recipient: Option<Box<models::SalesInvoiceRecipientResponse>>,
    ...
    pub discount: Option<Box<models::SalesInvoiceDiscountResponse>>,
...
impl EntitySalesInvoiceResponse {
    pub fn new() -> EntitySalesInvoiceResponse {
