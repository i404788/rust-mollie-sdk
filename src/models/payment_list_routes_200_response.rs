...
pub struct PaymentListRoutes200Response {
    ...
    pub _embedded: Option<Box<models::PaymentListRoutes200ResponseEmbedded>>,
    #[serde(rename = "_links", skip_serializing_if = "Option::is_none")]
    pub _links: Option<Box<models::PaymentListRoutes200ResponseLinks>>,
}

impl PaymentListRoutes200Response {
    pub fn new() -> PaymentListRoutes200Response {
