...
pub struct ListCaptures200Response {
    ...
    pub _embedded: models::ListCaptures200ResponseEmbedded,
    #[serde(rename = "_links")]
    pub _links: models::ListLinks,
}

impl ListCaptures200Response {
    pub fn new(count: i32, _embedded: models::ListCaptures200ResponseEmbedded, _links: models::ListLinks) -> ListCaptures200Response {
