...
pub struct ListSettlementChargebackResponse {
    ...
    #[serde(rename = "_links")]
    pub _links: models::ListEntityChargebackLinks,
    #[serde(rename = "mode", skip_serializing_if = "Option::is_none")]
    pub mode: Option<models::SettlementMode>,
}

impl ListSettlementChargebackResponse {
    pub fn new(resource: String, id: String, amount: models::Amount, payment_id: String, created_at: String, _links: models::ListEntityChargebackLinks) -> ListSettlementChargebackResponse {
