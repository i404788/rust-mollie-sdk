...
pub struct EntityTransferResponse {
    ...
    pub creditor: Option<models::TransferParty>,
    ...
    #[serde(rename = "transferScheme", skip_serializing_if = "Option::is_none")]
    pub transfer_scheme: Option<models::TransferSchemeResponse>,
    ...
    pub status_history: Option<Vec<models::StatusHistoryEntryResponse>>,
...
impl EntityTransferResponse {
    pub fn new() -> EntityTransferResponse {
