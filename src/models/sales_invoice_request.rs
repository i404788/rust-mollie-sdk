...
pub struct SalesInvoiceRequest {
    ...
    #[serde(rename = "status")]
    pub status: models::SalesInvoiceStatus,
    ...
    #[serde(rename = "recipientIdentifier")]
    pub recipient_identifier: String,
    #[serde(rename = "recipient")]
    pub recipient: models::SalesInvoiceRecipient,
    ...
    #[serde(rename = "lines")]
    pub lines: Vec<models::SalesInvoiceLineItem>,
...
impl SalesInvoiceRequest {
    pub fn new(status: models::SalesInvoiceStatus, recipient_identifier: String, recipient: models::SalesInvoiceRecipient, lines: Vec<models::SalesInvoiceLineItem>) -> SalesInvoiceRequest {
        SalesInvoiceRequest {
            resource: None,
            id: None,
            mode: None,
