...
pub enum PaymentDetailsFeeRegionResponse {
...
impl std::fmt::Display for PaymentDetailsFeeRegionResponse {
...
impl Default for PaymentDetailsFeeRegionResponse {
    fn default() -> PaymentDetailsFeeRegionResponse {
