...
pub struct ListSalesInvoices200Response {
    ...
    pub _embedded: Option<Box<models::ListSalesInvoices200ResponseEmbedded>>,
    #[serde(rename = "_links", skip_serializing_if = "Option::is_none")]
    pub _links: Option<Box<models::ListLinks>>,
}

impl ListSalesInvoices200Response {
    pub fn new() -> ListSalesInvoices200Response {
