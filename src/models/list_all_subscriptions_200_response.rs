...
pub struct ListAllSubscriptions200Response {
    ...
    pub _embedded: Box<models::ListAllSubscriptions200ResponseEmbedded>,
    #[serde(rename = "_links")]
    pub _links: Box<models::ListLinks>,
}

impl ListAllSubscriptions200Response {
    pub fn new(count: i32, _embedded: models::ListAllSubscriptions200ResponseEmbedded, _links: models::ListLinks) -> ListAllSubscriptions200Response {
