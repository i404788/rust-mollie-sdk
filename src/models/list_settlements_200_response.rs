...
pub struct ListSettlements200Response {
    ...
    pub _embedded: Box<models::ListSettlements200ResponseEmbedded>,
    #[serde(rename = "_links")]
    pub _links: Box<models::ListLinks>,
}

impl ListSettlements200Response {
    pub fn new(count: i32, _embedded: models::ListSettlements200ResponseEmbedded, _links: models::ListLinks) -> ListSettlements200Response {
