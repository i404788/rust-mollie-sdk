...
pub struct ListProfiles200Response {
    ...
    pub _embedded: models::ListProfiles200ResponseEmbedded,
    #[serde(rename = "_links")]
    pub _links: models::ListLinks,
}

impl ListProfiles200Response {
    pub fn new(count: i32, _embedded: models::ListProfiles200ResponseEmbedded, _links: models::ListLinks) -> ListProfiles200Response {
