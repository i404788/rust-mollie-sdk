...
pub enum SalesInvoiceStatusUpdate {
    #[serde(rename = "draft")]
    Draft,
    #[serde(rename = "issued")]
    Issued,
...
impl std::fmt::Display for SalesInvoiceStatusUpdate {
...
impl Default for SalesInvoiceStatusUpdate {
    fn default() -> SalesInvoiceStatusUpdate {
        Self::Draft
    }
}
