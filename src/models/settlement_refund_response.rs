...
pub struct SettlementRefundResponse {
...
impl SettlementRefundResponse {
    pub fn new(resource: String, id: String, mode: models::SettlementMode, description: String, amount: models::Amount, metadata: Option<models::Metadata>, status: models::SettlementRefundStatus, created_at: String, _links: models::EntityRefundLinks) -> SettlementRefundResponse {
