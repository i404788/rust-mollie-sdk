...
pub struct EntityPaymentResponse {
    ...
    pub routing: Option<Option<Vec<models::EntityPaymentRouteResponse>>>,
    ...
    pub details: Option<Box<models::EntityPaymentResponseDetails>>,
...
impl EntityPaymentResponse {
    pub fn new() -> EntityPaymentResponse {
