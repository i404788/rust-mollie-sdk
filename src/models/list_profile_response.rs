...
pub struct ListProfileResponse {
    ...
    pub status: Option<models::ProfileStatusResponse>,
    #[serde(rename = "review", skip_serializing_if = "Option::is_none")]
    pub review: Option<models::ListEntityProfileReview>,
    /// The entity's date and time of creation, in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format.
    #[serde(rename = "createdAt", skip_serializing_if = "Option::is_none")]
    pub created_at: Option<String>,
    #[serde(rename = "_links", skip_serializing_if = "Option::is_none")]
    pub _links: Option<models::ListEntityProfileLinks>,
}

impl ListProfileResponse {
    pub fn new(business_category: String) -> ListProfileResponse {
        ListProfileResponse {
            resource: None,
            id: None,
            mode: None,
