...
pub enum PaymentLinkMethodResponse {
...
impl std::fmt::Display for PaymentLinkMethodResponse {
...
impl Default for PaymentLinkMethodResponse {
    fn default() -> PaymentLinkMethodResponse {
        Self::Applepay
    }
}
