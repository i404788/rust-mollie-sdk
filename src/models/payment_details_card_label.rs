...
/// PaymentDetailsCardLabel : The card's label, if known.
/// The card's label, if known.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum PaymentDetailsCardLabel {
...
impl std::fmt::Display for PaymentDetailsCardLabel {
...
impl Default for PaymentDetailsCardLabel {
    fn default() -> PaymentDetailsCardLabel {
