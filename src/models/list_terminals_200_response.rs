...
pub struct ListTerminals200Response {
    ...
    pub _embedded: Box<models::ListTerminals200ResponseEmbedded>,
    #[serde(rename = "_links")]
    pub _links: Box<models::ListLinks>,
}

impl ListTerminals200Response {
    pub fn new(count: i32, _embedded: models::ListTerminals200ResponseEmbedded, _links: models::ListLinks) -> ListTerminals200Response {
