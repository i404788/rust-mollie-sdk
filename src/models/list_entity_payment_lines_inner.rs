...
pub struct ListEntityPaymentLinesInner {
    ...
    pub recurring: Option<models::RecurringLineItem>,
}

impl ListEntityPaymentLinesInner {
    pub fn new(description: String, quantity: i32, unit_price: models::Amount, total_amount: models::Amount) -> ListEntityPaymentLinesInner {
