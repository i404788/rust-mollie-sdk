...
pub struct ListChargebacks200Response {
    ...
    pub _embedded: models::ListChargebacks200ResponseEmbedded,
    #[serde(rename = "_links")]
    pub _links: models::ListLinks,
}

impl ListChargebacks200Response {
    pub fn new(count: i32, _embedded: models::ListChargebacks200ResponseEmbedded, _links: models::ListLinks) -> ListChargebacks200Response {
