...
pub struct ListPayments200Response {
    ...
    pub _embedded: models::ListPayments200ResponseEmbedded,
    #[serde(rename = "_links")]
    pub _links: models::ListLinks,
}

impl ListPayments200Response {
    pub fn new(count: i32, _embedded: models::ListPayments200ResponseEmbedded, _links: models::ListLinks) -> ListPayments200Response {
