...
pub struct ClientLinkRequest {
    ...
    #[serde(rename = "owner")]
    pub owner: models::EntityClientLinkOwner,
    /// Name of the organization.
    #[serde(rename = "name")]
    pub name: String,
    #[serde(rename = "address")]
    pub address: models::EntityClientLinkAddress,
...
impl ClientLinkRequest {
    pub fn new(owner: models::EntityClientLinkOwner, name: String, address: models::EntityClientLinkAddress) -> ClientLinkRequest {
        ClientLinkRequest {
            resource: None,
            id: None,
            owner,
