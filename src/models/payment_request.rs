...
pub struct PaymentRequest {
    ...
    pub lines: Option<Vec<models::EntityPaymentLinesInner>>,
    ...
    pub routing: Option<Vec<models::EntityPaymentRoute>>,
    ...
    pub company: Option<Box<models::ExtraParameterParametersCompany>>,
