...
pub struct ListEntityCapture {
    ...
    pub status: Option<models::CaptureStatusResponse>,
    ...
    pub _links: Option<models::ListEntityCaptureLinks>,
}

impl ListEntityCapture {
    pub fn new() -> ListEntityCapture {
        ListEntityCapture {
            resource: None,
            id: None,
            mode: None,
