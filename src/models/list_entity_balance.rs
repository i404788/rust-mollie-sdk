...
impl ListEntityBalance {
    pub fn new(resource: String, id: String, mode: models::Mode, created_at: String, currency: models::Currencies, description: String, status: models::BalanceStatus, available_amount: models::Amount, pending_amount: models::Amount, _links: models::ListEntityBalanceLinks) -> ListEntityBalance {
        ListEntityBalance {
            resource,
            id,
            mode,
