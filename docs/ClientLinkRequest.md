...
**owner** | [**models::EntityClientLinkOwner**](EntityClientLinkOwner.md) |  | 
**name** | **String** | Name of the organization. | 
**address** | [**models::EntityClientLinkAddress**](EntityClientLinkAddress.md) |  | 
...
**_links** | Option<[**models::EntityClientLinkLinks**](EntityClientLinkLinks.md)> |  | [optional]
