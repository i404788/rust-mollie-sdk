...
**categories** | Option<[**Vec<models::LineCategoriesResponse>**](LineCategoriesResponse.md)> | An array with the voucher categories, in case of a line eligible for a voucher. See the [Integrating Vouchers](https://docs.mollie.com/docs/integrating-vouchers/) guide for more information. | [optional]
