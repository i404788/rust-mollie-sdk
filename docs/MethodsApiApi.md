...
------------- | ------------- | -------------
[**disable_method**](MethodsApiApi.md#disable_method) | **DELETE** /v2/profiles/{profileId}/methods/{methodId} | Disable payment method
[**disable_method_issuer**](MethodsApiApi.md#disable_method_issuer) | **DELETE** /v2/profiles/{profileId}/methods/{methodId}/issuers/{issuerId} | Disable payment method issuer
[**enable_method**](MethodsApiApi.md#enable_method) | **POST** /v2/profiles/{profileId}/methods/{methodId} | Enable payment method
[**enable_method_issuer**](MethodsApiApi.md#enable_method_issuer) | **POST** /v2/profiles/{profileId}/methods/{methodId}/issuers/{issuerId} | Enable payment method issuer
[**get_method**](MethodsApiApi.md#get_method) | **GET** /v2/methods/{methodId} | Get payment method
[**list_all_methods**](MethodsApiApi.md#list_all_methods) | **GET** /v2/methods/all | List all payment methods
[**list_methods**](MethodsApiApi.md#list_methods) | **GET** /v2/methods | List payment methods



## disable_method

> disable_method(profile_id, method_id, idempotency_key)
...
**method_id** | [**Method**](Method.md) | Provide the ID of the related payment method. | [required] |
...
> disable_method_issuer(profile_id, method_id, issuer_id, idempotency_key)
...
------------- | ------------- | ------------- | ------------- | -------------
**profile_id** | **String** | Provide the ID of the related profile. | [required] |
**method_id** | [**MethodIdWithIssuer**](MethodIdWithIssuer.md) | Provide the ID of the related payment method. | [required] |
**issuer_id** | **String** | Provide the ID of the related issuer. | [required] |
**idempotency_key** | Option<**String**> | A unique key to ensure idempotent requests. This key should be a UUID v4 string. |  |
...
> models::EntityMethodGet enable_method(profile_id, method_id, idempotency_key)
...
[**models::EntityMethodGet**](entity-method-get.md)
...
> models::EnableMethodIssuer200Response enable_method_issuer(profile_id, method_id, issuer_id, idempotency_key, enable_method_issuer_request)
...
> models::EntityMethodGet get_method(method_id, locale, currency, profile_id, include, sequence_type, testmode, idempotency_key)
Get payment method
...
------------- | ------------- | ------------- | ------------- | -------------
**method_id** | [**Method**](Method.md) | Provide the ID of the related payment method. | [required] |
**locale** | Option<[**Locale**](Locale.md)> | Response language |  |
...
**sequence_type** | Option<[**SequenceType**](SequenceType.md)> | Set this parameter to `first` to only return the methods that can be used for the first payment of a recurring sequence.  Set it to `recurring` to only return methods that can be used for recurring payments or subscriptions. |  |
...
------------- | ------------- | ------------- | ------------- | -------------
**locale** | Option<[**Locale**](Locale.md)> | Response language |  |
**amount** | Option<[**Amount**](Amount.md)> | If supplied, only payment methods that support the amount and currency are returned.  Example: `/v2/methods/all?amount[value]=100.00&amount[currency]=USD` |  |
**include** | Option<**String**> | This endpoint allows you to include additional information via the `include` query string parameter. |  |
**sequence_type** | Option<[**SequenceType**](SequenceType.md)> | Set this parameter to `first` to only return the methods that can be used for the first payment of a recurring sequence.  Set it to `recurring` to only return methods that can be used for recurring payments or subscriptions. |  |
**profile_id** | Option<**String**> | The identifier referring to the [profile](get-profile) you wish to retrieve the resources for.  Most API credentials are linked to a single profile. In these cases the `profileId` must not be sent. For organization-level credentials such as OAuth access tokens however, the `profileId` parameter is required. |  |
**testmode** | Option<**bool**> | Most API credentials are specifically created for either live mode or test mode. In those cases the `testmode` query parameter must not be sent. For organization-level credentials such as OAuth access tokens, you can enable test mode by setting the `testmode` query parameter to `true`.  Test entities cannot be retrieved when the endpoint is set to live mode, and vice versa. |  |
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**sequence_type** | Option<[**SequenceType**](SequenceType.md)> | Set this parameter to `first` to only return the enabled methods that can be used for the first payment of a recurring sequence.  Set it to `recurring` to only return enabled methods that can be used for recurring payments or subscriptions. |  |
**locale** | Option<[**Locale**](Locale.md)> | Response language |  |
**amount** | Option<[**Amount**](Amount.md)> | If supplied, only payment methods that support the amount and currency are returned.  Example: `/v2/methods?amount[value]=100.00&amount[currency]=USD` |  |
**resource** | Option<[**MethodResourceParameter**](MethodResourceParameter.md)> | **⚠️ We no longer recommend using the Orders API. Please refer to the [Payments API](payments-api) instead.**  Indicate if you will use the result for the [Create order](create-order) or the [Create payment](create-payment) endpoint.  When passing the value `orders`, the result will include payment methods that are only available for payments created via the Orders API. |  |
...
**include_wallets** | Option<[**MethodIncludeWalletsParameter**](MethodIncludeWalletsParameter.md)> | A comma-separated list of the wallets you support in your checkout. Wallets often require wallet specific code to check if they are available on the shoppers device, hence the need to indicate your support. |  |
**order_line_categories** | Option<[**LineCategories**](LineCategories.md)> | A comma-separated list of the line categories you support in your checkout.  Example: `/v2/methods?orderLineCategories=eco,meal` |  |
**profile_id** | Option<**String**> | The identifier referring to the [profile](get-profile) you wish to retrieve the resources for.  Most API credentials are linked to a single profile. In these cases the `profileId` must not be sent. For organization-level credentials such as OAuth access tokens however, the `profileId` parameter is required. |  |
**include** | Option<**String**> | This endpoint allows you to include additional information via the `include` query string parameter. |  |
**testmode** | Option<**bool**> | Most API credentials are specifically created for either live mode or test mode. In those cases the `testmode` query parameter must not be sent. For organization-level credentials such as OAuth access tokens, you can enable test mode by setting the `testmode` query parameter to `true`.  Test entities cannot be retrieved when the endpoint is set to live mode, and vice versa. |  |
**idempotency_key** | Option<**String**> | A unique key to ensure idempotent requests. This key should be a UUID v4 string. |  |
