...
**website** | **String** | The URL to the profile's website or application. Only `https` or `http` URLs are allowed. No `@` signs are allowed. | 
...
**status** | Option<[**models::ProfileStatus**](ProfileStatus.md)> |  | [optional][readonly]
**review** | Option<[**models::EntityProfileReview**](EntityProfileReview.md)> |  | [optional]
...
**_links** | Option<[**models::EntityProfileLinks**](EntityProfileLinks.md)> |  | [optional]
