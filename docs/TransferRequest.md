...
**debtor_iban** | **String** | The IBAN of the debtor's (sender) Mollie account from which to initiate the transfer. | 
...
**transfer_scheme** | [**models::TransferScheme**](TransferScheme.md) |  | 
