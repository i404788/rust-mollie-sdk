...
**method** | [**models::MandateMethod**](MandateMethod.md) |  | 
**consumer_name** | **String** | The customer's name. | 
...
**details** | Option<[**models::EntityMandateDetails**](EntityMandateDetails.md)> |  | [optional]
...
**scopes** | Option<[**Vec<models::MandateScopes>**](MandateScopes.md)> | An array defining the eligible use cases for the mandate. This field will always be  present and can contain one or both of the following values: | [optional][readonly]
**status** | Option<[**models::MandateStatus**](MandateStatus.md)> |  | [optional][readonly]
...
**_links** | Option<[**models::EntityMandateLinks**](EntityMandateLinks.md)> |  | [optional]
