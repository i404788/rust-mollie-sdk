...
------------ | ------------- | ------------- | -------------
**r#type** | Option<[**models::PaymentLineType**](payment-line-type.md)> |  | [optional]
...
**categories** | Option<[**Vec<models::LineCategories>**](line-categories.md)> | An array with the voucher categories, in case of a line eligible for a voucher. See the [Integrating Vouchers](https://docs.mollie.com/docs/integrating-vouchers/) guide for more information. | [optional]
