...
------------ | ------------- | ------------- | -------------
**r#type** | [**models::SalesInvoiceRecipientTypeResponse**](sales-invoice-recipient-type-response.md) |  | 
...
**locale** | [**models::SalesInvoiceRecipientLocaleResponse**](sales-invoice-recipient-locale-response.md) |  | 
