...
------------ | ------------- | ------------- | -------------
**resource** | **String** | Indicates the response contains a transfer object. Will always contain the string `business-account-transfer` for this endpoint. | [readonly]
**id** | **String** | The identifier uniquely referring to this transfer. Mollie assigns this identifier at transfer creation time. | [readonly]
...
**debtor** | [**models::TransferParty**](TransferParty.md) | The debtor (sender) of the transfer, including their name and account details. | [readonly]
**creditor** | [**models::TransferParty**](TransferParty.md) | The creditor (recipient) of the transfer, including their name and account details. | 
**amount** | [**models::Amount**](Amount.md) | The amount of the transfer, e.g. `{\"currency\":\"EUR\", \"value\":\"100.00\"}` if you would want to transfer €100.00.  Only `EUR` is supported for SEPA transfers. | 
...
**business_account_transaction_id** | **String** | The identifier of the corresponding transaction in the business accounts transaction resource. | [readonly]
**transfer_scheme** | [**models::TransferSchemeResponse**](TransferSchemeResponse.md) |  | 
**credit_debit_indicator** | [**models::CreditDebitIndicator**](CreditDebitIndicator.md) |  | 
**status** | [**models::TransferStatus**](TransferStatus.md) |  | 
**status_history** | [**Vec<models::StatusHistoryEntryResponse>**](StatusHistoryEntryResponse.md) | A chronological list of status transitions the transfer has gone through. | [readonly]
