...
**method** | Option<[**models::MandateMethodResponse**](mandate-method-response.md)> |  | [optional]
...
**details** | Option<[**models::EntityMandateResponseDetails**](entity_mandate_response_details.md)> |  | [optional]
...
**status** | Option<[**models::MandateStatus**](mandate-status.md)> |  | [optional][readonly]
...
**_links** | Option<[**models::EntityMandateLinks**](entity_mandate__links.md)> |  | [optional]
