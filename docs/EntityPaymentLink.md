...
**id** | Option<**String**> | The identifier uniquely referring to this payment link. Example: `pl_4Y0eZitmBnQ6IDoMqZQKh`. | [optional][readonly]
...
**amount** | Option<[**models::AmountNullable**](AmountNullable.md)> | The amount of the payment link. If no amount is provided initially, the customer will be prompted to enter an amount. | [optional]
...
**allowed_methods** | Option<[**Vec<models::PaymentLinkMethodResponse>**](PaymentLinkMethodResponse.md)> | An array of payment methods that are allowed to be used for this payment link. When this parameter is not provided or is an empty array, all enabled payment methods will be available. | [optional]
...
**_links** | Option<[**models::CreatePaymentLinkRequestLinks**](CreatePaymentLinkRequestLinks.md)> |  | [optional]
