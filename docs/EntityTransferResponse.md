...
**transfer_scheme** | Option<[**models::TransferSchemeResponse**](TransferSchemeResponse.md)> |  | [optional]
...
**status_history** | Option<[**Vec<models::StatusHistoryEntryResponse>**](StatusHistoryEntryResponse.md)> | A chronological list of status transitions the transfer has gone through. | [optional][readonly]
