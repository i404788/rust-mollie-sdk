...
**id** | Option<**String**> | The identifier uniquely referring to this subscription. Example: `sub_rVKGtNd6s3`. | [optional][readonly]
**mode** | Option<[**models::Mode**](Mode.md)> |  | [optional]
**status** | Option<[**models::SubscriptionStatusResponse**](SubscriptionStatusResponse.md)> |  | [optional][readonly]
...
**method** | Option<[**models::SubscriptionMethodResponse**](SubscriptionMethodResponse.md)> |  | [optional]
...
**customer_id** | Option<**String**> | The customer this subscription belongs to. | [optional][readonly]
...
**_links** | Option<[**models::ListEntitySubscriptionLinks**](ListEntitySubscriptionLinks.md)> |  | [optional]
