...
------------- | ------------- | -------------
[**get_invoice**](InvoicesApiApi.md#get_invoice) | **GET** /v2/invoices/{invoiceId} | Get invoice
[**list_invoices**](InvoicesApiApi.md#list_invoices) | **GET** /v2/invoices | List invoices



## get_invoice

> models::EntityInvoice get_invoice(invoice_id, idempotency_key)
Get invoice
...
------------- | ------------- | ------------- | ------------- | -------------
**invoice_id** | **String** | Provide the ID of the related invoice. | [required] |
...
> models::ListInvoices200Response list_invoices(reference, year, from, limit, sort, idempotency_key)
List invoices
