...
------------ | ------------- | ------------- | -------------
**resource** | **String** | Indicates the response contains a mandate object. Will always contain the string `mandate` for this endpoint. | [readonly]
**id** | **String** | The identifier uniquely referring to this mandate. Example: `mdt_pWUnw6pkBN`. | 
**mode** | [**models::Mode**](Mode.md) |  | 
**method** | [**models::MandateMethodResponse**](MandateMethodResponse.md) |  | 
...
**details** | [**models::ListEntityMandateDetails**](ListEntityMandateDetails.md) |  | 
**signature_date** | **String** | The date when the mandate was signed in `YYYY-MM-DD` format. | 
**mandate_reference** | **String** | A custom mandate reference. For SEPA Direct Debit, it is vital to provide a unique reference. Some banks will decline Direct Debit payments if the mandate reference is not unique. | 
...
**status** | [**models::MandateStatusResponse**](MandateStatusResponse.md) |  | [readonly]
**customer_id** | **String** | The identifier referring to the [customer](get-customer) this mandate was linked to. | [readonly]
...
**_links** | [**models::ListEntityMandateLinks**](ListEntityMandateLinks.md) |  | 
