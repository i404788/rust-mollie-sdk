...
**email** | Option<**String**> | The email address associated with the profile's trade name or brand. | [optional]
...
**status** | Option<[**models::ProfileStatus**](profile-status.md)> |  | [optional][readonly]
**review** | Option<[**models::EntityProfileResponseReview**](entity_profile_response_review.md)> |  | [optional]
...
**_links** | Option<[**models::EntityProfileLinks**](entity_profile__links.md)> |  | [optional]
