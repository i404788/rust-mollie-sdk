...
**status** | Option<[**models::SalesInvoiceStatus**](SalesInvoiceStatus.md)> |  | [optional]
...
**payment_details** | Option<**serde_json::Value**> |  | [optional]
...
**recipient** | Option<[**models::SalesInvoiceRecipient**](SalesInvoiceRecipient.md)> |  | [optional]
